...
@job(description="Drop the atp schema - WARNING: This will delete all data!", tags={"service": "wst", "schema": "atp"})
def wst_atp_drop_job():
    """Job to drop the atp schema and all its objects. Use with caution!"""
    wst_atp_drop_op()


@job(description="Instantiate the atp schema with all tables and permissions", tags={"service": "wst", "schema": "atp"})
...
@job(description="Complete backup, drop, instantiate, and reload sequence", tags={"service": "wst", "schema": "atp", "function": "bak"})
